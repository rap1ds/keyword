...
describe('text format', function() {
  ...
  describe('#encode', function() {
    it('encodes keyword object to text format', function() {
      var keys = {
        "First Keyword Name": [
          "First Key To Run",
          "Second Key To Run"
      ...
      expect(text.encode(keys)).to.be.eql([
        "First Keyword Name",
        "    First Key To Run",
        "    Second Key To Run",
        "",
    ...
    it('decoding encoded object equals the original object', function() {
      var keys = {
        "First Keyword Name": [
          "First Key To Run",
          "Second Key To Run"
      ...
      expect(text.decode(text.encode(keys))).to.be.eql(keys);
    });
  });
});