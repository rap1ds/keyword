...
function isRegexpKeywordName(str) {
    var validKeywordRegexp = /^\/(.*)\/(.*)$/;
    return validKeywordRegexp.exec(str);
}
...
var validators = Object.freeze({
    ...
    isRegexpKeywordName: isRegexpKeywordName,
    isKeywordName: isKeywordName
});
